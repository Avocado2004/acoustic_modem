...
if __name__ == "__main__":
    ...
    # 5) save mono-WAV
    # здесь мы удваиваем частоту (I/Q→реальный поток в 2×FS)
    fs_iq = fs * 2
    wavfile.write("ofdm_iq.wav", fs_iq,
    ...
    fs2, wavd = wavfile.read("ofdm_iq.wav")
    # fs2 должен быть = 2×fs
    if fs2 != fs_iq:
        print(f"Warning: expected sample rate {fs_iq}, got {fs2}")
